...
export const homeBuiltBannerImage = {
  src: '/course-images/available-1.jpg',
  fallbackSrc: '/course-images/new-arrival-1.jpg',
  alt: 'Structured FMNXT learning paths and course content'
} as const

export const homeWhyImage = {
  src: '/course-images/available-2.jpg',
  fallbackSrc: '/course-images/new-arrival-2.jpg',
  alt: 'FMNXT platform learning experience'
} as const

export const homeLearningTrackImages = [
  {
    src: '/course-images/new-arrival-1.jpg',
    fallbackSrc: '/course-images/available-1.jpg',
    alt: 'FM Fundamentals track, matching catalog imagery'
  },
  {
    src: '/course-images/new-arrival-2.jpg',
    fallbackSrc: '/course-images/available-2.jpg',
    alt: 'CRE Essentials track course visuals'
  },
  {
    src: '/course-images/new-arrival-3.jpg',
    fallbackSrc: '/course-images/available-3.jpg',
    alt: 'MEP and asset care content from FMNXT courses'
  }
] as const

export const homeFaqVisualImage = {
  src: '/course-images/available-1.jpg',
  fallbackSrc: '/course-images/new-arrival-1.jpg',
  alt: 'FMNXT course discovery and learning'
} as const

export const homeFaqAccentImages = [
  {
    src: '/course-images/new-arrival-2.jpg',
    fallbackSrc: '/course-images/available-2.jpg',
    alt: 'FMNXT member learning context'
  },
  {
    src: '/course-images/available-3.jpg',
    fallbackSrc: '/course-images/new-arrival-3.jpg',
    alt: 'FMNXT professional development programs'
  }
] as const
